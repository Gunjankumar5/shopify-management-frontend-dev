...
export const ICONS = {
  ...
  users:
    "M17 20h5v-2a3 3 0 00-5.196-1.489M9.172 20H2v-2a3 3 0 015.196-1.487M12 14a4 4 0 100-8 4 4 0 000 8zm6-3.5c1.105 0 2-.895 2-2s-.895-2-2-2-2 .895-2 2 .895 2 2 2zM7 9.5a2 2 0 100-4 2 2 0 000 4z",
  settings:
